...
_C.LOSS = CfgNode()
_C.LOSS.LAMBDA_A = 5.0
_C.LOSS.LAMBDA_B = 5.0
_C.LOSS.LAMBDA_IDT = 0.5
_C.LOSS.LAMBDA_CLS = 1
_C.LOSS.LAMBDA_REC = 10
_C.LOSS.LAMBDA_HIS = 3
_C.LOSS.LAMBDA_SKIN = 0.3
_C.LOSS.LAMBDA_EYE = 3
...
_C.PREPROCESS.UP_RATIO = 0.6 / 0.85  
_C.PREPROCESS.DOWN_RATIO = 0.2 / 0.85  
_C.PREPROCESS.WIDTH_RATIO = 0.2 / 0.85  
